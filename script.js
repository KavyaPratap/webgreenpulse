    ...
    try {
        const response = await fetch(endpoint, {
            ...
            body: JSON.stringify({
                contents: [{
                    role: "user",
                    parts: [{ text: `As a senior care assistant, respond ONLY to these questions about E-Sahara: ${allowedQuestions.join(', ')}. For greetings, respond briefly. For any other queries, say: "I can only answer questions about E-Sahara's services. Please ask one of the listed questions." Current query: ${userMessage}` }]
                }]
            }),
        });
